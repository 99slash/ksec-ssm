                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" id="myform" action="/user/save" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" id="studentId" name="studentId" value="${s.studentId}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sex" class="col-sm-1 control-label">性别</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" id="sex" name="sex" value="${s.sex}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-8">
                                    ...
                                    &nbsp; &nbsp; &nbsp;
                                    <button type="submit" class="btn btn-info" id="back">
